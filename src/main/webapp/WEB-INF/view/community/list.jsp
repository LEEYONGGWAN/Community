...
<body>
	...
	<div id="wrapper">
		...
		<table>
		 ...
		 <!-- 서브밋이 되면 무브페이지를 실행 하라(지금 서브밋 자꾸되서 배드리퀘스트 뜸) -->
		<form id="searchForm" onsubmit="movePage('0')">
			...
			<div>
				<select id="searchType" name="searchType">
					...
					<option value="7" ${search.searchType eq 7 ? 'selected' : '' }>첨부파일 확장자</option>
				</select>
				<!-- 내가 지금 이런걸 검색하는 중이야 라는걸  value를 통해 알려줌 -->
